...
class Prefs(context: Context) {
    private val PREFS_FILENAME = "app.launch0"
    ...
    private val HOURLY_WALLPAPER = "DAILY_WALLPAPER"
    ...
    var hourlyWallpaper: Boolean
        get() = prefs.getBoolean(HOURLY_WALLPAPER, false)
        set(value) = prefs.edit { putBoolean(HOURLY_WALLPAPER, value).apply() }

    var hourlyWallpaperSeed: String
        get() = prefs.getString(HOURLY_WALLPAPER_SEED, "").toString()
