...
Launch0 is a fork of [Olauncher](https://github.com/tanujnotes/Olauncher). It shares the same foundation but is developed independently, positioned as an operating system for the busy. If you want extra features like weather, widgets, fonts, and folders, check out [Olauncher Pro](https://play.google.com/store/apps/details?id=app.prolauncher).
